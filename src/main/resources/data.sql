...
VALUES (1, 'Sony', 'Electronics brand', 'sony_logo.png'),
...
INSERT INTO "product" ("id", "name", "price", "description", "rating_total", "category_id", "brand_id", "img_url",
                       "quantity")
...
INSERT INTO "order" ("id", "user_id", "status_id", "price", "created_at", "updated_at")
VALUES (1, 1, 1, 599.99, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (2, 2, 2, 89.99, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


-- Insert data into "ordered_products"
INSERT INTO "ordered_products" ("product_id", "order_id")
VALUES (1, 1),
       (2, 2);

-- Insert data into "products_in_basket"
INSERT INTO "products_in_Basket" ("product_id", "basket_id", "quantity")
VALUES (1, 1, 1),
       (2, 2, 2);
